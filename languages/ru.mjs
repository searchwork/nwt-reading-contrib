...
export default {
    ...
    showEvents: {
        ...
        title: '«Все Писание вдохновлено Богом и полезно»',
        chapter: 'Урок № 3 - События в потоке времени',
        caption: 'Таблица важных исторических дат',
    },
    ...
    helpPage: [
        ...
        'NWT Reading поможет вам следить за своим расписанием чтения \
            "Священного Писания - Перевода нового мира", изданного Свидетелями Иеговы.',

        'Как это работает',
        'Выберите план чтения и продолжительность вверху страницы.',
        'Отмечайте главы, которые вы прочитали.',
    ...
    //
    privacyPolicyPage: [
        '«Мобильное приложение «NWT Reading («ПРОДУКТ») не собирает \
        никакую личную информацию. Все данные хранятся локально.',
