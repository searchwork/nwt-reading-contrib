...
export default {
    ...
    resetEndDate: {
        label: 'Gbugbɔ Ðo Nuwuwu Ŋkekea',
        description: 'Gbugbɔ ɖo ŋkeke si dzi nàwu enu be wòanɔ game dzi kple nuxexlẽ.',
        question: 'Àgbugbɔ ŋkeke si dzi nàwu enu be wòanɔ game dzi kple nuxexlẽa?',
    },
    withEndDate: {
        label: 'Kple Nuwuwu Ɣletiŋkeke',
        description: 'Lé ŋku ɖe gbesiagbe nuxexlẽ ŋu kple ŋkeke si dzi nàwu enu.',
    },
    showEvents: {
        label: 'Fia Nudzɔdzɔwo (dodokpɔ).',
